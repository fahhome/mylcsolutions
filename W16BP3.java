...
public class W16BP3 {
    ...
    public static String solve(String A) {
        ...
        int minDigits = 2;
        // why we starting from a maxvalue?
        // because base is inversly proprtional to no of digits. . .so to get minimum
        // base we have to start with maximum no of digits which 60 in our case
